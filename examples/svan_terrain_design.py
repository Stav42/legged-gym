...
def test_terrain(): return SubTerrain(width=num_rows, length=num_cols, vertical_scale=horizontal_scale, horizontal_scale=horizontal_scale)



heightfield[0:num_rows, :] = spherical_indentation_terrain_3(test_terrain(), slope=0.5).height_field_raw
heightfield[num_rows:2*num_rows, :] = sloped_terrain(new_sub_terrain(), slope=-0.5).height_field_raw
heightfield[2*num_rows:3*num_rows, :] = spherical_indentation_terrain_2(new_sub_terrain(), slope=0.5).height_field_raw
